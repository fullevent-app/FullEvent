---
title: wideLogger
description: Hono middleware for Wide Event logging.
---
...
<APIReference>
<APIMethod name="wideLogger(config)" category="Function">
<APIMethodContent>
<APIMethodLeft>
...
<APIReturns type="void">Hono middleware function</APIReturns>
</APIMethodLeft>
<APIMethodRight>
<APISignature>{`wideLogger(config: WideLoggerConfig): void`}</APISignature>
<APIExamples>{`import { Hono } from 'hono';
